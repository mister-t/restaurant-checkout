    ...
    <>
      ...
      {modalVisible && <Modal >
        ...
        <div className="flex flex-col items-center w-screen sm:w-full">
          ...
          <form onSubmit={onSubmit} className="flex flex-col border-2 p-8 rounded-md">
            <div className="flex justify-between mb-10">
              <section className="flex justify-start">
                <input className="accent-mgPurple focus:outline-none" id="add-new-credit-card" type="radio" name="cardType" value="Add a new card" defaultChecked />
            ...
            <div className="flex flex-col items-start mb-5">
              ...
              <input className="w-full rounded-md pl-[10px] py-[4px] border-2 focus:outline-none " id="full-name" type="text" placeholder="John Doe" required />
            </div>
            <div>
              ...
              <div className="flex flex-col md:flex-row justify-between rounded-md border-2">
                ...
                <section className="">
                  <input id="cc-month" maxLength={2} placeholder="MM" className="w-7 focus:outline-none py-[4px]" required />
                  <span className='text-slate-800/50 mx-1 w-2'>/</span>
                  <input id="cc-year" maxLength={2} placeholder="YY" className="w-7 pr-1 focus:outline-none py-[4px]" required />
                  <input id="cc-cvc" maxLength={3} placeholder="CVC" className="w-8 mx-2 focus:outline-none py-[4px]" required />
                </section>
              </div>
            </div>
          </form>
